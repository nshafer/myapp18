defmodule Myapp18Web.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: Myapp18Web.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Myapp18Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Myapp18Web.Gettext, "errors", msg, opts)
    end
  end
