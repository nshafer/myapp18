defmodule Myapp18Web.ConnCase do
  @moduledoc """
  ...
  by setting `use Myapp18Web.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import Myapp18Web.ConnCase
    end
  end

  setup tags do
    Myapp18.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_user(%{conn: conn} = context) do
    user = Myapp18.AccountsFixtures.user_fixture()
    scope = Myapp18.Accounts.Scope.for_user(user)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    Myapp18.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
